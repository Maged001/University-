...
class array_process {
    ...
    public void addprocess( int id, int at, int bt, int pri) { // add process to the array;
    ...
    public boolean Scheduling() {
        ...
        for (int Ctime = 0; Ctime < total_time; Ctime++) {
            ...
            // if same process still in running state dont print and increment complete time by one;
                ...
                thedata[indexOf(Nid)].setComplet_time(); // if same process load to running dont print it;
            }
   ...
   // welcome screen
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            //check if the valus is not valid and print error massege
            if (!done || at < 0 || bt <= 0) {
